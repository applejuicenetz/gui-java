...
public class AJSettings
{
   ...
   public AJSettings(String nick, long port, long xmlPort, long maxUpload, long maxDownload, int speedPerSlot, String incomingDir,
                     String tempDir, Set<ShareEntry> shareDirs, long maxConnections, boolean autoConnect,
                     long maxNewConnectionsPerTurn, long maxSourcesPerFile)
   {
      this.nick                     = nick;
      this.port                     = port;
