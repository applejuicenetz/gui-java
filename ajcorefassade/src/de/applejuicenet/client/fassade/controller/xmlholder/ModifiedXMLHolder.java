...
/**
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/applejuicejava/Repository/ajcorefassade/src/de/applejuicenet/client/fassade/controller/xmlholder/Attic/ModifiedXMLHolder.java,v 1.1 2004/12/03 07:57:12 maj0r Exp $
 *
...
public class ModifiedXMLHolder
    ...
    private void checkForValidResult(String xmlString, Securer securer){
        if (xmlString.indexOf("wrong password") != -1){
            ...
            throw new RuntimeException("Das Passwort wurde coreseitig geaendert.\r\nDas GUI wird beendet.");
        }
    }
