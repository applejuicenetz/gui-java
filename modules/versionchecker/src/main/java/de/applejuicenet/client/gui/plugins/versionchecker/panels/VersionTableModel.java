...
{
   final static String[] COL_NAMES = {"", "Windows", "Linux", "Mac", "Solaris", "OS/2", "FreeBSD", "NetWare", "?"};
   ...
   public Object getValueAt(int row, int column)
   {
      ...
      switch(column)
      {
         ...
         case 1:
            return Integer.toString(versionHolder.countWin) + getPercent(versionHolder, versionHolder.countWin);

         case 2:
            return Integer.toString(versionHolder.countLinux) + getPercent(versionHolder, versionHolder.countLinux);

         case 3:
            return Integer.toString(versionHolder.countMac) + getPercent(versionHolder, versionHolder.countMac);

         case 4:
            return Integer.toString(versionHolder.countSolaris) + getPercent(versionHolder, versionHolder.countSolaris);

         case 5:
            return Integer.toString(versionHolder.countOS2) + getPercent(versionHolder, versionHolder.countOS2);

         case 6:
            return Integer.toString(versionHolder.countFreeBSD) + getPercent(versionHolder, versionHolder.countFreeBSD);

         case 7:
            return Integer.toString(versionHolder.countNetWare) + getPercent(versionHolder, versionHolder.countNetWare);

         case 8:
            return Integer.toString(versionHolder.countSonstige) + getPercent(versionHolder, versionHolder.countSonstige);
