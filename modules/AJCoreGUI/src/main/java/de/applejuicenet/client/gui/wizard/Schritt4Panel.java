...
/**
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/applejuicejava/Repository/AJClientGUI/src/de/applejuicenet/client/gui/wizard/Schritt4Panel.java,v 1.14 2009/01/12 09:19:20 maj0r Exp $
 *
...
public class Schritt4Panel extends WizardPanel
{
   ...
   {
      label1.setText(languageSelector.getFirstAttrbuteByTagName("javagui.wizard.schritt4.label1"));
      label2.setText(languageSelector.getFirstAttrbuteByTagName("javagui.wizard.schritt4.label2"));
   }
}
