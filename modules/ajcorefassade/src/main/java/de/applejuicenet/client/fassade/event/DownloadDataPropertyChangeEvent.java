...
public class DownloadDataPropertyChangeEvent extends DataPropertyChangeEvent
{
   ...
   public DownloadDataPropertyChangeEvent(Object source, Object name, Object oldValue, Object newValue)
   {
      super(source, name, oldValue, newValue);
   }

   public DownloadDataPropertyChangeEvent(Vector<DataPropertyChangeEvent> dataPropertyChangeEvents)
   {
