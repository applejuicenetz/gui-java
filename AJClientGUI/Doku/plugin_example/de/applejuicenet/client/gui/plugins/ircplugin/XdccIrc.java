...
public class XdccIrc
  ...
  private void makeConnectionInfo() {
    ...
    nickJTextField1.addFocusListener(new FocusAdapter(){
       public void focusLost(FocusEvent e){
        if (nickJTextField1.getText().length()!=0 && list.getSelectedIndex()!=-1)
    ...
    connectButton.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        if (list.getSelectedValue() != null) {
          ...
          tabUpdate("Init Window", " Connecting to: " + list.getSelectedValue());
  ...
  private void register() {
    ...
    parseSendToCommand("PASS xdcc6666");
