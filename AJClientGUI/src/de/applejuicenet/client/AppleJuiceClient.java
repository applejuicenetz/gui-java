...
/**
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/applejuicejava/Repository/AJClientGUI/src/de/applejuicenet/client/AppleJuiceClient.java,v 1.100 2006/05/03 14:21:11 maj0r Exp $
 *
         ...
         while(showDialog || (erreichbarkeit = ajFassade.isCoreAvailable()) != 0)
         {
            ...
            if(!showDialog)
            {
               if(erreichbarkeit == 2)
               {
                  ...
                  nachricht = ZeichenErsetzer.korrigiereUmlaute(languageSelector.getFirstAttrbuteByTagName(
                           ".root.javagui.startup.fehlversuch"));
