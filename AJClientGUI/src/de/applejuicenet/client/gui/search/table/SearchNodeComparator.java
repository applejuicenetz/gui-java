...
public class SearchNodeComparator implements Comparator{
    ...
    public static enum SORT_TYPE {SORT_NO_SORT, SORT_FILENAME, SORT_GROESSE, SORT_ANZAHL};
    ...
    public int compare(Object toCompare1, Object toCompare2) {
        Object o1 = null;
        Object o2 = null;
        if (sortType == SORT_TYPE.SORT_FILENAME) {
            SearchEntry entry1 = (SearchEntry) ( (SearchNode)
                    toCompare1).getValueObject();
