...
/**
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/applejuicejava/Repository/AJClientGUI/src/de/applejuicenet/client/gui/search/table/Attic/SearchNode.java,v 1.7 2006/10/26 13:34:06 maj0r Exp $
 *
...
public class SearchNode implements Node
{
   ...
   public Icon getConvenientIcon()
   {
      ...
      {
         return IconManager.getInstance().getIcon(((SearchEntry) valueObject).getFileType().toString());
      }
   }
   ...
   public String toString()
   {
      ...
      {
         FileName[] filenames   = ((SearchEntry) valueObject).getFileNames();
         int        haeufigkeit = 0;
         String     dateiname   = "";
