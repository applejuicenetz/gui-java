...
/**
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/applejuicejava/Repository/AJClientGUI/src/de/applejuicenet/client/gui/download/table/Attic/DownloadColumnValue.java,v 1.6 2009/01/10 13:39:19 maj0r Exp $
 *
...
public abstract class DownloadColumnValue
{
   ...
   {
      if(obj instanceof Download && ((Download) obj).getStatus() == Download.SUCHEN_LADEN)
      {
         return DownloadModel.getSpeedAsString(((Download) obj).getSpeedInBytes());
      }
      else if(obj instanceof DownloadSource && ((DownloadSource) obj).getStatus() == DownloadSource.UEBERTRAGUNG)
      {
   ...
   {
      if(obj instanceof Download &&
            (((Download) obj).getStatus() == Download.SUCHEN_LADEN || ((Download) obj).getStatus() == Download.PAUSIERT))
      {
         return DownloadModel.parseGroesse(((Download) obj).getGroesse() - ((Download) obj).getBereitsGeladen());
      }
      else if(obj instanceof DownloadSource)
      {
   ...
   {
      if(obj instanceof DownloadSource && ((DownloadSource) obj).getVersion() != null)
      {
