...
public class UploadPanel extends JPanel implements LanguageListener, RegisterI,
	...
	private void copyLinkToClipboard() {
		Object selectedItem = ((TreeTableModelAdapter) uploadDataTable
				.getModel()).nodeForRow(uploadDataTable.getSelectedRow());
		if (selectedItem.getClass() == UploadDO.class) {
	...
	public void fireLanguageChanged() {
		...
		label1.setText(clientText.replaceAll("%d", Integer
		...
		warteschlangeVoll = ZeichenErsetzer
				.korrigiereUmlaute(languageSelector
	...
	class HeaderPopupListener extends MouseAdapter {
		...
		private void maybeShowPopup(MouseEvent e) {
			if (e.isPopupTrigger()) {
				...
				columnPopup.show(uploadDataTable.getTableHeader(), e.getX(), e
						.getY());
			}
		}
	}
