  ...
  private void updateDownloads() {
    if (downloadMap == null) {
      ...
      Version version = new Version("0.27.511", "Java",
                                     Version.LINUX);
      DownloadSourceDO source = new DownloadSourceDO(false, Integer.toString(i), "dateXY3.jpg",
          DownloadSourceDO.VERSUCHEINDIREKT, "1GB", "nix", Integer.toString(i), "100", "0 Kb",
          "?", "1:1", version, "Maj0r", null);
