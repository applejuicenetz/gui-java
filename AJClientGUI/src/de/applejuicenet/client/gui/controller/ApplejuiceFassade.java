...
/**
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/applejuicejava/Repository/AJClientGUI/src/de/applejuicenet/client/gui/controller/Attic/ApplejuiceFassade.java,v 1.174 2004/12/07 13:56:52 maj0r Exp $
 *
...
public class ApplejuiceFassade {
    ...
    public static final String GUI_VERSION = "0.60.0-11-CVS";
    ...
    public boolean isLocalhost(){
    	...
    	if (coreHost.equalsIgnoreCase("127.0.0.1") 
    	        || coreHost.equalsIgnoreCase("localhost")){
    		return true;
    	}
    	else{
    		return false;
