...
public class UploadIconNodeRenderer extends DefaultIconNodeRenderer
{
                                                 ...
                                                 boolean hasFocus)
   {
      ...
      {
         c = super.getTreeCellRendererComponent(tree, ((Upload) value).getDateiName(), sel, expanded, leaf, row, hasFocus);
      }
      else if(value.getClass() == UploadMainNode.class)
      {
         c = super.getTreeCellRendererComponent(tree,
                                                ((UploadMainNode) value).toString() + " (" +
                                                ((UploadMainNode) value).getChildCount() + ")", sel, expanded, leaf, row, hasFocus);
      }
      else
      {
