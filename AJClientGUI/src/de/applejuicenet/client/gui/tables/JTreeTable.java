...
/**
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/applejuicejava/Repository/AJClientGUI/src/de/applejuicenet/client/gui/tables/Attic/JTreeTable.java,v 1.20 2003/12/29 16:04:17 maj0r Exp $
 *
...
public class JTreeTable extends JTable{
  ...
  public class IconNodeRenderer
    ...
    public Component getTreeCellRendererComponent(JTree tree, Object value,
      ...
      else if (value.getClass()==Search.SearchEntry.FileName.class){
          c = super.getTreeCellRendererComponent(tree, ((Search.SearchEntry.FileName)value).getDateiName(),
                                       sel, expanded, leaf, row, hasFocus);
      }
      else{
