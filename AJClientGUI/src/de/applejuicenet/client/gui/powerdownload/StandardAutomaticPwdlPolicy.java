...
/**
 * $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/applejuicejava/Repository/AJClientGUI/src/de/applejuicenet/client/gui/powerdownload/Attic/StandardAutomaticPwdlPolicy.java,v 1.1 2003/11/17 07:32:30 maj0r Exp $
 *
...
public class StandardAutomaticPwdlPolicy extends AutomaticPowerdownloadPolicy{
    private ApplejuiceFassade applejuiceFassade;

    public StandardAutomaticPwdlPolicy(){}

    public void doAction() throws InterruptedException{
        applejuiceFassade = ApplejuiceFassade.getInstance();
        ...
        while(!isInterrupted()){
            ...
            synchronized(downloads){
                ...
                if (currentId==-1){
                        ...
                        applejuiceFassade.setPowerDownload(new int[]{maxProzentId}, 14);
